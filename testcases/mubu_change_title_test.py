...
# FROM: testcases\mubu_change_title.yml
...
from testcases.mubu_create_doc_test import TestCaseMubuCreateDoc as MubuCreateDoc
...
if __name__ == "__main__":
    TestCaseMubuChangeTitle().test_start()
